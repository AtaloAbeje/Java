...
class TCPClient_with_serialized {
	...
	public static void main(String argv[]) throws Exception {
		...
		while (true) {
			...
			System.out.println("Please Choose your Categor: "); //choose Category
			...
			switch (Category) {
				case "0": {
					...
					if(modifiedSentence.matches("bye bye!"))
						break;
				}
				...
				case "1": { 			//its a housecommite
					...
					System.out.println("2 Change ur password");
					...
					if (choice2.matches("1")) {//enter with a username&password
						...
						if (modifiedSentence.matches("Wellcom!! ")) { // if its was the right username&password
							while(!choice2.matches("0")) {	//while we still want to do things as a housecommite
								...
								speciality="non";
								Tenant_num=-1;
								System.out.println("Please select ur choose: ");
								System.out.println("1 for Show a specific tenant payments");
								System.out.println("2 for Show all of the payments in your building");
								System.out.println("3 for Set up new building");
								System.out.println("4 for Update a specific tenant payment");
								System.out.println("5 for Delete tenant payment");
								System.out.println("6 for Monthly income of your building");
								System.out.println("7 for Show Suppliers");
								System.out.println("8 for Enter a new supplier");
								System.out.println("0 for To exit");
							...
							case"4":{// Update a specific tenant payment
								System.out.println("Please enter the appartment numbe: ");
								app_num=inFromUser.nextLine();
							...
							case"8": {	// Enter a new supplier
								System.out.println("Please Enter supplier firstname: ");
								String SupName=inFromUser.next();
								System.out.println("Please Enter supplier Lastname:");
								String SupLast=inFromUser.next();
								System.out.println("Please Enter supplier specializes -> electrician/plumber/renovation: ");	
